...
import graphTheme from "./Graph";
import svgCircleTheme from "./SVGCircle";
import svgLineTheme from "./SVGLine";
import svgTextTheme from "./SVGText";
import svgPolygonTheme from "./SVGPolygon";
import svgTheme from "./Svg";
...
export default (variables /*: * */ = variable) => {
  const theme = {
    ...
    "NativeBase.Graph": {
      ...graphTheme(variables)
    },
    "NativeBase.SVGCircle": {
      ...svgCircleTheme(variables)
    },
    "NativeBase.SVGLine": {
      ...svgLineTheme(variables)
    },
    "NativeBase.SVGText": {
      ...svgTextTheme(variables)
    },
    "NativeBase.SVGPolygon": {
      ...svgPolygonTheme(variables)
    },
    "NativeBase.Svg": {
      ...svgTheme(variables)
    },
  ...
  const cssifyTheme = (grandparent, parent, parentKey) => {
    ...
    parent.forEach((style, styleName) => {
      if (
        styleName.indexOf(".") === 0 &&
        parentKey &&
        parentKey.indexOf(".") === 0
